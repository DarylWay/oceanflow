...
public class ReceiverStart {
     ...
     */
    @Bean
    public ConcurrentKafkaListenerContainerFactory filterContainerFactory(@Value("${oceanflow.business.tagId.key}") String tagIdKey,
                                                                          @Value("${oceanflow.business.tagId.value}") String tagIdValue) {
